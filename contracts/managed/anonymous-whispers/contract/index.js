...
export class Contract {
  ...
  constructor(...args_0) {
      ...
      submit_report: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submit_report',
                                     ...
                                     'anonymous-whispers.compact line 64 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(content_hash_0).concat(_descriptor_2.toValue(report_content_0)),
    ...
    this.impureCircuits = { submit_report: this.circuits.submit_report };
    this.provableCircuits = { submit_report: this.circuits.submit_report };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {

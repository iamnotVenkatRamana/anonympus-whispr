...
/**
 * The technical trust markers, closing out the light world.
 *
 ...
 * exists on chain.
 *
 * Split from the footer so the light-world wrapper in Landing can own this
 * section's background while the footer returns to black outside it.
 */
export function TechStrip() {
  return (
    <section
      className="w-full border-t px-6 py-10 md:px-10"
      style={{ borderColor: 'rgb(10 10 11 / 0.09)', color: 'var(--muted-light)' }}
    >
      <div className="mono mx-auto flex max-w-5xl flex-col gap-4 text-[12px] md:flex-row md:items-center md:justify-between">
        <p>midnight {NETWORK_LABEL} · compact contract · curve25519 · zk proofs</p>
...
/** Back to the dark world for the closing line. */
export function SiteFooter() {
  return (
    <footer className="w-full bg-black px-6 py-20 text-white md:px-10 md:py-28">
      <div className="mx-auto max-w-5xl">
        <p className="hero-title max-w-3xl text-[8vw] leading-[1.02] font-semibold md:text-[3vw]">
